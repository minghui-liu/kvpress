...
step_tracking_files = list(Path("token_tracking_results").glob("*.step_tracking.json"))

target_budget = 256
target_press_name = "full"
target_model_list = [
            ...
            def highlight_keywords_in_text(text: str, keywords: set) -> str:
                ...
                for keyword in sorted_keywords:
                    ...
                    while True:
                        ...
                        if idx == -1:
                            break
                        matches.append((idx, idx + len(keyword), keyword))
                        start = idx + 1
                ...
                for start, end, keyword in non_overlapping:
