...
DATASET_DICT = {
    # niah
    "mt_niah_S": "../MT_RULER/test/multi_turn_niah_small.jsonl",
    "mt_niah_M": "../MT_RULER/test/multi_turn_niah_medium.jsonl",
    "mt_niah_L": "../MT_RULER/test/multi_turn_niah_large.jsonl",
    "mt_niah_S_50": "../MT_RULER/test/multi_turn_niah_small_50.jsonl",
    # vt
    "mt_vt_S": "../MT_RULER/test/multi_turn_vt_small.jsonl",
    "mt_vt_M": "../MT_RULER/test/multi_turn_vt_medium.jsonl",
    "mt_vt_L": "../MT_RULER/test/multi_turn_vt_large.jsonl",
    "mt_vt_S_50": "../MT_RULER/test/multi_turn_vt_small_50.jsonl",
    # pr
    "mt_pr_S": "../MT_RULER/test/multi_turn_pr_small.jsonl",
    "mt_pr_M": "../MT_RULER/test/multi_turn_pr_medium.jsonl",
    "mt_pr_L": "../MT_RULER/test/multi_turn_pr_large.jsonl",
    "mt_pr_S_50": "../MT_RULER/test/multi_turn_pr_small_50.jsonl",
}
